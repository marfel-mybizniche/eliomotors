            ...
            <div class="grid-container">
                <div class="grid-x grid-margin-x align-center">
                    <div class="cell large-9">
                        <h5>Why Elio?</h5>
                        <h1>The ultimate vehicle for commuting daily</h1>
                        <p>In a nutshell, Elio is the ultimate vehicle for commuting daily. Electric vehicles, like their predecessor gas engines, are increasingly getting more expensive, with an entry level electric starting at just under $40,000. Something needed to give and Elio reversed engineered a solution. With a car entirely engineered from off-the-shelf parts, from the top suppliers in the world, a under 20,000 option was born.</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="grid-x">
                <div class="cell large-11 large-offset-1 xlarge-10 xlarge-offset-2">
                    <div class="mission_copy">
                        ...
                        <p>We are committed to the American dream, creating American jobs, and bringing American automotive ingenuity to every vehicle we build.</p>
                        <p><strong>This is, and will remain our mission at Elio.</strong></p>
                    </div>
                    <div class="mission_image">
                        <figure class="bg"><img src="<?php echo MBN_ASSETS_URI; ?>/img/about-5a.jpg" alt=""></figure>
                        <img class="logo" src="<?php echo MBN_ASSETS_URI; ?>/img/icn-logo.png" width="208" alt="">
                        <p>Say Hello to up to the ultimate electric commuter vehicle, American made for only targeted $14,900* base price!</p>
                    </div>
            </div>
            </div>
        </div>
        ...
        <div class="grid-container">
            ...
            <div class="grid-x grid-margin-x member_item">
                ...
                <div class="cell large-6 xlarge-5">
                    ...
                    <p>Before Next Autoworks, he was co-founder and Chief Operating Officer at ESG Engineering, a product development firm specializing in automotive and clean tech applications. Mr. Iyer began his automotive career at Johnson Controls (JCI) Automotive Systems Group, where he was involved in several OEM programs for interiors components.</p>
                    <p>Mr. Iyer received his M.S. in Mechanical Engineering from Penn State and his M.B.A. from Stanford Graduate School of Business.</p>
                    <p>Mr. Schembri previously was the President of smart USA, a Penske Automotive Group company. He was responsible for the successful launch of smart USA (a division of Mercedes-Benz), which included establishing and maintaining a sales and service retail network, customer relations, logistics, advertising, marketing, PR, government relations, and a parts distribution network.</p>
                    <p>Mr. Schembri has over 35 years of automotive experience. The majority of his career was realized in various executive positions at Mercedes-Benz and Volkswagen. While at Mercedes Benz, Dave served as both the Vice President of Sales and Vice President of Marketing. During his tenure, Schembri was responsible for several successful product launches while the company recorded 11 consecutive record years in new vehicle sales. In addition to his corporate responsibilities, Mr. Schembri served on the Board of Directors for the Boomer Esiason Foundation (BEF) in their effort to raise funds for research to find a cure for cystic fibrosis.</p>
                    <p>Mr. Schembri is currently the CEO of the Active Aero Group, a Platinum Equity Company. He attended the University of Detroit, where earned both his Bachelor’s degree and his MBA.</p>
                </div>
            </div>
        </div>
    </section>
