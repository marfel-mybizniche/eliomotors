...
function find_us_gmap() { 
    ...
    $postvar .='<div class="location_map' + $location_category1->slug + '">';
    ...
    $postvar   .= '<ul class="location_states">';
        ...
        foreach ( $location_categories as $location_category ) {
            ...
            $argsLoc2 = array('post_type' => 'location', 'posts_per_page' => -1, 'post_status' => 'publish','orderby' => 'title', 'order' => 'ASC', 'tax_query' => array( 'relation' => 'AND', array( 'taxonomy' => 'locations-cat', 'field' => 'slug', 'terms' => $location_category->slug, 'include_children' => false )));
